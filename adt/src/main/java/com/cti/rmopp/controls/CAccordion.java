...
//import javax.swing.CButton;
import javax.swing.JComponent;
import javax.swing.JFrame;
import javax.swing.JLabel;
//import javax.swing.CPanel;
 ...
 * visible component
 */
public class CAccordion extends CPanel implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6029869528583138150L;

	/**
	 * The top panel: contains the buttons displayed on the top of the
	 * JOutlookBar
	 */
	private CPanel topPanel = new CPanel(new GridLayout(1, 1));

	/**
	 * The bottom panel: contains the buttons displayed on the bottom of the
	 * JOutlookBar
	 */
	private CPanel bottomPanel = new CPanel(new GridLayout(1, 1));
	 ...
	 * Debug, dummy method
	 */
	public static CPanel getDummyPanel(String name) {
	...
	public static void main(String[] args) {
		...
		CAccordion outlookBar = new CAccordion();
	 ...
	 * 
	 * name The name of the bar button The associated CButton for the bar
	...
	class BarInfo {
		...
		/**
		 * The CButton that implements the Outlook bar itself
		 */
		...
		public BarInfo(String name, JComponent component) {
			...
			this.button = new CButton(name);
			button.setPreferredSize(new Dimension(button.getWidth(), 60));
		}
		...
		public BarInfo(String name, Icon icon, JComponent component) {
			this.name = name;
			this.component = component;
			this.button = new CButton(name, icon);
			button.setPreferredSize(new Dimension(button.getWidth(), 60));
		}
		...
		/**
		 * Returns the outlook bar CButton implementation
		 * 
		 * @return The Outlook Bar CButton implementation
		 */
