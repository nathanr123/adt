	...
	public PropertyDescriptor[] getPropertyDescriptors()
	{
		try
		{
			...
			orientationDescriptor.setValue("enumerationValues", new Object[] { 
					"X_AXIS", Integer.valueOf(AbstractDefaultAxisScale.X_AXIS), "com.cti.vpx.controls.graph.utilities.ui.graphs.graphBase.cAxis.X_AXIS",
					"Y_AXIS", Integer.valueOf(AbstractDefaultAxisScale.Y_AXIS), "com.cti.vpx.controls.graph.utilities.ui.graphs.graphBase.cAxis.Y_AXIS",
			});
