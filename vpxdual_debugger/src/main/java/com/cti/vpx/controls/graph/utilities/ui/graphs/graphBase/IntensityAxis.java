...
public class IntensityAxis extends JPanel implements ILocaleListener
{
	...
	public IntensityAxis()
	{
		...
		oWaterfallOnOffButton.setIcon(IconManager.getSizedFor("/com/cti/vpx/controls/graph/utilities/ui/images/colour_waterfall_off.png", this, 1.2f));
		oWaterfallOnOffButton.setSelectedIcon(IconManager.getSizedFor("/com/cti/vpx/controls/graph/utilities/ui/images/colour_waterfall.png", this, 1.2f));
