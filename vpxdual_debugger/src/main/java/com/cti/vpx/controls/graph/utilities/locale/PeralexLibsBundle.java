 ...
 * 
 * This class also serves as a template for how to implement this code in other
 * projects. The intention is to reduce the amount of code clutter and other
 * coding in all of the other classes in this project.
 */
public final class PeralexLibsBundle {
	private static final GenericBundle bundle = new GenericBundle("com.cti.vpx.controls.graph.utilities");
