...
public class FileCopierUtility extends JFrame implements ActionListener, PropertyChangeListener {
	...
	private void buildGUI() {
		...
		JScrollPane scrollPane = new JScrollPane(txtDetails, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
		...
		panInput.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Input"),
		...
		panDetails.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Details"),
				BorderFactory.createEmptyBorder(5, 5, 5, 5)));
	...
	public void actionPerformed(ActionEvent e) {
		if ("Copy".equals(btnCopy.getText())) {
			...
			if (!source.exists()) {
				JOptionPane.showMessageDialog(this, "The source file/directory does not exist!", "ERROR",
