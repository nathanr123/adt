package com.cti.vpx.controls.graph.utilities.ui.graphs.hopperHistogram;
...
public interface IHopperHistogram {
	 ...
	 *
	 * @param asDimensionName
	 *            the name of the dimension
	 * @param asDimensionUnitName
	 *            the name of units for the dimension
	 * @param awNumPoints
	 *            the number of points in the histogram for this dimension (ns)
	 * @param afMinScaleValue
	 *            minimum value for the scale of the dimension
	 * @param afMaxScaleValue
	 *            maximum value for the scale of the dimension
	 * @param abIsLogarithmic
	 *            is the dimension's scale logarithmic?
	 * @param afHistogramData
	 *            histogram data
	 */
	void onDataReceived(String[] asDimensionName, String[] asDimensionUnitName, short[] awNumPoints,
			float[] afMinScaleValue, float[] afMaxScaleValue, boolean[] abIsLogarithmic, float[] afHistogramData);
	 ...
	 *
	 * @param oBackgroundColor
	 *            contains the new color.
	 */
