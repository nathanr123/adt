...
import com.cti.vpx.controls.graph.utilities.ui.graphs.hopperHistogram.dualChannel.HistogramDualChannel;
import com.cti.vpx.controls.graph.utilities.ui.graphs.hopperHistogram.singleChannel.HistogramSingleChannel;

/**
 * This class creates a new HopperHistogramGraph.
 */
public class HopperHistogramGraph extends JPanel implements ILocaleListener {
	private static final long serialVersionUID = -2368669322340839014L;
	 ...
	 *            histogram data
	 */
	public synchronized void onDataReceived(String[] asDimensionName, String[] asDimensionUnitName, short[] awNumPoints,
			float[] afMinScaleValue, float[] afMaxScaleValue, boolean[] abIsLogarithmic, float[] afHistogramData) {
		oHistogram.onDataReceived(asDimensionName, asDimensionUnitName, awNumPoints, afMinScaleValue, afMaxScaleValue,
				abIsLogarithmic, afHistogramData);
	}
	 ...
	 *            contains the maximum
	 */
	public synchronized void setAxisRanges(double dXAxisMinimum, double dXAxisMaximum, double dYAxisMinimum,
			double dYAxisMaximum) {
