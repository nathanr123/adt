...
public abstract class DrawSurface extends JComponent implements ILocaleListener {
	private static final long serialVersionUID = 3405764221168806461L;
	 ...
	 * FIXME: these should be of type Object rather than type int, to prevent
	...
	/**
	 * override this method to handle local changed events - it will be running
	 * on the event thread.
	 */
