...
public class GBFormBuilder {
	 ...
	 */
	public void appendLn(Component component1, GridBagConstraints gbc1,
			Component component2, GridBagConstraints gbc2)
	{
	 ...
	 */
	private void append(
					Component component1, GridBagConstraints gbc1,
					Component component2, GridBagConstraints gbc2)
	{
		if (component1!=null)
		{
	 ...
	 */
	public void appendLn(Component component, int noFormColumns,
					int noFormRows, Fill fill)
	{
	...
	private void append(Component component, 
			int noFormColumns, int noFormRows,	Fill fill, 
			Stretch stretch)
	{
		final GridBagConstraints gbc = new GridBagConstraints();
		gbc.anchor = GridBagConstraints.NORTHWEST;
	 ...
	 *   to be allocated
	 */
	public void appendLn(Component component, 
			int noFormColumns, int noFormRows,	Fill fill, 
			Stretch stretch)
	{
	 ...
	 */
	public void appendLn(Component component, 
			int noFormColumns, int noFormRows, Fill fill, Anchor anchor)
	{
	 ...
	 */
	private void append(Component component, 
					int noFormColumns, int noFormRows,
	...
	public void nextColumnPair() {
		/* Set up the spacer components between the column pairs
		 */
		final GridBagConstraints gbc = new GridBagConstraints();
		gbc.anchor = GridBagConstraints.WEST;
	...
	public static class Separator extends JPanel {
		...
		public Separator(String text) {
			...
			// the space makes the separator look better
			final GridBagConstraints gbc2 = new GridBagConstraints();
			gbc2.gridx = 1;
			add(new JLabel(" "), gbc2);
