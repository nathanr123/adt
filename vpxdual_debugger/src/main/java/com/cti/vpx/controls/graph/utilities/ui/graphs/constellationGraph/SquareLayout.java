package com.cti.vpx.controls.graph.utilities.ui.graphs.constellationGraph;
...
/**
 * A Layout manager that sizes it's component to be square, and in the centre of
 * it's parent.
 * 
 * This is useful for the constellation graph because a constellation graph
 * needs to be square.
 */
public class SquareLayout implements LayoutManager2 {
	...
	public void addLayoutComponent(String name, Component _comp) {
		if (this.comp != null)
			throw new IllegalStateException("there can be one and only component in a SquareLayout");
		this.comp = _comp;
	}
	...
	/**
	 * Required by LayoutManager. This is called when the panel is first
	 * displayed, and every time its size changes. Note: You CAN'T assume
	 * preferredLayoutSize or minimumLayoutSize will be called -- in the case of
	 * applets, at least, they probably won't be.
	 */
