...
public interface IGridListener {
	 ...
	 */
	void scalingFactorChanged(GridDrawSurface surface, long lXScalingFactor, String sXScaleUnit, long lYScalingFactor,
			String sYScaleUnit);
	 ...
	 *            0 for x, 1 for y
	 */
	void gridChanged(int axisType, double dMinimum, double dMaximum, long lScalingFactor, boolean bProportional,
			double[] adGridValues, int[] aiGridCoordinates);
