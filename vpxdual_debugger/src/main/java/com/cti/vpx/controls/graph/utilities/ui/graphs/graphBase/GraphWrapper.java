...
/**
 * This wraps the graph proper and provides titles, x-axis and y-axis labels,
 * and a co-ordinate panel.
 * 
 ...
 * settings.
 * 
 * FIXME: we have the names of some methods confused. e.g. setXAxisVisible()
 * should be called setXAxisScaleVisible() and setXAxisScaleVisible() should be
 * called setXAxisPanelVisible().
 * 
 * FIXME: de-couple the relationship between this and cGraphBase by using an
 * interface. Gives me more options when creating new kinds of graphs.
 * 
...
public class GraphWrapper extends javax.swing.JPanel implements ILocaleListener {
	...
	public GraphWrapper() {
		...
		/*
		 * make the default title font be 20% bigger than the default font, and
		 * bold
		 */
	...
	private class MyGridListener implements IGridListener {
		public void mouseCoordinatesChanged(GridDrawSurface surface, final double fXValue, final double fYValue) {
			if (oCoordinatesPanel != null) {
				oCoordinatesPanel.setCoordinates(fXValue / oGraph.getXScalingFactor(),
						fYValue / oGraph.getYScalingFactor());
			}
		}

		public void scalingFactorChanged(GridDrawSurface surface, long lXScalingFactor, String sXScaleUnit,
		...
		public void gridChanged(int axis, double minimum, double maximum, long scalingFactor, boolean proportional,
				double[] afGridValues, int[] aiGridCoordinates) {
		}
	}
	...
	/**
	 * This is a very raw method for adding stuff to a GraphWrapper. It means
	 * that you are using the wrapper purely as a layout class, and none of the
	 * axis and cursor/coordinate stuff is in operation.
	 */
	...
	/**
	 * This will set the visibility of the x-scale i.e. the thing with numbers
	 * and marks on it.
	 */
	...
	/**
	 * This will set the visibility of the y-scale i.e. the thing with numbers
	 * and marks on it.
	 */
	 ...
	 */
	public void setAxisTitlesAndUnits(String sXAxisTitle, String sXAxisUnit, String sYAxisTitle, String sYAxisUnit) {
	...
	private void internalSetAxisTitlesAndUnits() {
		if (GraphWrapper.this.sXAxisUnit != null && !GraphWrapper.this.sXAxisUnit.equals("")) {
			...
			oXAxisLabel.setText(GraphWrapper.this.sXAxisTitle + " (" + xScaleUnit + GraphWrapper.this.sXAxisUnit + ")");
		} else {
		...
		if (GraphWrapper.this.sYAxisUnit != null && !GraphWrapper.this.sYAxisUnit.equals("")) {
			...
			oYAxisLabel.setText(GraphWrapper.this.sYAxisTitle + " (" + yScaleUnit + GraphWrapper.this.sYAxisUnit + ")");
		} else {
	...
	/**
	 * Add an extra component below the x-axis panel. Useful for additional GUI
	 * elements that need to be the same width as the x-axis.
	 */
	...
	/**
	 * This panel is meant for adding extra functionality to the x-axis area. By
	 * default, it has a BorderLayout.
	 * 
	 * Useful for additional GUI elements that need to be the same width as the
	 * x-axis.
	 */
	...
	/**
	 * Add an extra component to the right of the graph draw surface. This
	 * component is sized to the same height as the graph draw surface, but is
	 * positioned to the right of the graph and the title area.
	 * 
	...
	/**
	 * This panel is meant for adding extra functionality to the header area,
	 * between the title and the co-ordinates panel.
	 * 
	...
	/**
	 * This panel is meant for adding extra functionality to the header area,
	 * between the title and the left edge of the graph.
	 * 
	 * By default, it has a BorderLayout.
	 */
	...
	/**
	 * This panel is meant for adding extra functionality to the header area,
	 * between the title and the top edge of the graph. It spans the width of
	 * the graph. Useful for adding components to the top of the graph that need
	 * to be exactly as wide as the graph.
	 * 
	 * By default, it has a BorderLayout.
	 */
	...
	/**
	 * Get the top left corner panel. This method is so that clients of this
	 * class can add extra widgets to that space.
	 * 
	 * By default, it has a BorderLayout.
	 */
	...
	/**
	 * Get the bottom left corner panel. This method is so that clients of this
	 * class can add extra widgets to that space.
	 * 
	 * By default, it has a BorderLayout.
	 */
	...
	/**
	 * This will add the given component to the HeaderPanel at the top, spanning
	 * the full width of the header panel, sitting above the title and
	 * co-ordinates panel.
	 */
	...
	/**
	 * This will remove the current co-ordinates panel, and disconnect the
	 * auto-updating of the coordinates that normally happens.
	 */
	public void replaceCoordinatesPanel(JPanel newCoordinatesPanel) {
		if (oCoordinatesPanel == null)
			throw new IllegalStateException("panel already been replaced");
